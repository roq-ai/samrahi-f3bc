...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'inventory-manager', 'purchasing-agent', 'accountant'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Vendors', path: '/vendors', entity: 'vendor', service: AccessServiceEnum.PROJECT, icon: FiBox },
