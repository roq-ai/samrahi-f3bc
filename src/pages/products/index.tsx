...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'buying_quantity', header: 'buying_quantity', accessorKey: 'buying_quantity' },
    { id: 'price_per_unit', header: 'price_per_unit', accessorKey: 'price_per_unit' },
    { id: 'discount', header: 'discount', accessorKey: 'discount' },
    { id: 'total_price', header: 'total_price', accessorKey: 'total_price' },
    { id: 'unit_sent', header: 'unit_sent', accessorKey: 'unit_sent' },
